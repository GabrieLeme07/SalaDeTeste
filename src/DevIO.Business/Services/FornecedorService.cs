...
namespace DevIO.Business.Services
{
    public class FornecedorService : BaseService, IFornecedorService
    {
        ...
        public FornecedorService(IFornecedorRepository fornecedorRepository,
                                 ...
                                 INotificador notificador, IMediator mediator) : base(notificador)
        {
        ...
        public void AdicionarMock(Fornecedor fornecedor)
        {
        ...
        public void RemoverMock(Fornecedor fornecedor)
        {
            _fornecedorRepository.Remover(fornecedor.Id);
            _mediator.Publish(fornecedor);
        }
        public void InactivateMock(Fornecedor fornecedor)
        {
            if (!fornecedor.IsValid())
                return;
